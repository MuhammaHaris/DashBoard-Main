...
function Tablelist() {
  return (
    <div>
      {' '}
      <div className='grid grid-cols-2 rounded-xl z-50 bg-blue-500 mx-5 p-5'>
        <div className='w-full'>
          <h1 className='font-semibold text-white'>Projects</h1>
          <div className='flex gap-1'>
            <BsCheckAll size={25} color='#55AEF7' />
            <p className='text-white'>
              {' '}
              <span className='font-semibold text-white'>30 done</span> this
              month
            </p>
          </div>
        </div>
        <div className='w-full m-auto flex justify-end '>
          <CgMenuRound size={25} color='#FFFFFF' />
        </div>
      </div>
      <div className='w-full bg-white  mb-10 -mt-10  pt-12 rounded-xl shadow-lg'>
        {/* Header */}
        <div className=' '>
          {/* Navbar */}
